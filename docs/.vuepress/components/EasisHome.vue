    ...
    <div class="home-blog">
        <div class="hero" :style="{ ...bgImageStyle }">
            <div>
                ...
                <ModuleTransition delay="0.10">
                    <p class="action" v-if="recoShowModule && $frontmatter.actionText && $frontmatter.actionLink">
                        <NavLink class="action-button" :item="actionLink"/>
                        <NavLink class="action-button demo" :item="{link:'http://v2.ts5.it',text:'立即体验 →'}"/>
                    </p>
                </ModuleTransition>
            </div>
        </div>
...
import NoteAbstract from 'vuepress-theme-reco/components/NoteAbstract'
import { ModuleTransition, RecoIcon } from '@vuepress-reco/core/lib/components'
import PersonalInfo from 'vuepress-theme-reco/components/PersonalInfo'
...
export default defineComponent({
    ...
    setup (props, ctx) {
        ...
        return { recoShowModule, heroImageStyle, actionLink, bgImageStyle, ...toRefs(state), getOneColor }
    },
    methods: {
...
.home-blog {
    ...
    margin: 0px auto;
    .hero {
        margin $navbarHeight - 3.6rem auto 0
        position relative
